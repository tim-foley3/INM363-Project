...
{
    //Channel 0 because we want walls/terrain that cast shadows 
    //to be in channel 0, then things hidden in shadows in channel 1.
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    {
        // A 0.0 - 1.0 ratio between where our current pixel is, and 
        // where the light is
        float t = i / N;
